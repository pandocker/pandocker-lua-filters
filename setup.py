...
list_of_filters = ["lua/aafigure.lua",
                   ...
                   "lua/docx-codeblock-linenumber.lua",
                   ...
                   "lua/docx-tabularize-figures.lua",
...
setup(
    ...
    name='pandocker-lua-filters',  # Required
    ...
    use_scm_version={
        ...
        "write_to": "pandocker_lua_filters/version.py",
    },
    ...
    description='Lua filter collection for pandoc',  # Optional
    ...
    url='https://github.com/pandocker/pandocker-lua-filters',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='pandocker',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='pandocker@github.com',  # Optional
    ...
    keywords='Pandoc Lua Filter',  # Optional
    ...
    install_requires=["aafigure"],  # Optional
